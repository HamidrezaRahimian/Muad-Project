    ...
    <section>
        ...
        <ul class="listofdata">
            <li class="eachlist"><strong>Hauptplatine:</strong>
                <p class="textoflist"> Die Hauptplatine, auch als Motherboard bekannt, ist die zentrale Platine eines
            ...
            <li class="eachlist"><strong>Eingabe:</strong>
                <p class="textoflist"> Im Kontext von Computern bezieht sich der Begriff "Eingabe" auf den Prozess, bei
                    dem
                    Daten oder Befehle in ein Computersystem eingegeben werden. Dies kann durch Tastaturen, Mäuse,
            ...
            <li class="eachlist"><strong>Ausgabe:</strong>
                <p class="textoflist"> Der Begriff "Ausgabe" bezieht sich auf die Präsentation von verarbeiteten
                    Informationen oder Ergebnissen durch ein Computersystem. Dies kann über Bildschirme, Drucker,
            ...
            <li class="eachlist"><strong>Externspeicher:</strong>
                <p class="textoflist"> Externspeicher bezeichnet Speichermedien außerhalb des Hauptcomputers, die Daten
                    ...
                    (foto1, foto2, foto3, foto,4, foto5 ) </p>
            </li>
